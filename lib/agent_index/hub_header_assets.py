...
HUB_PAGE_HEADER_CSS = """
    ...
    .hub-page-menu-btn {
      ...
      cursor: pointer; transition: all 0.2s ease; padding: 0; margin: 0;
      -webkit-tap-highlight-color: transparent;
    }
    .hub-page-menu-btn:hover { background: rgba(255,255,255,0.08); color: #fff; transform: scale(1.05); }
    .hub-page-menu-btn:active { background: rgba(255,255,255,0.12); transform: scale(0.95); }
  ...
  (function() {
    ...
    if (menuBtn && bridge) {
      var _syncBridge = function() {
        if (menuBtn.offsetParent === null) return;
      ...
      window.addEventListener("scroll", _syncBridge, { passive: true, capture: true });
      // Orientation change or dynamic layout shifts
      ...
      menuBtn.addEventListener("click", function(e) {
        // Bridge handled by overlay, but fallback for non-showPicker browsers
