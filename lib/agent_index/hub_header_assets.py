...
<div class="hub-page-menu-panel" id="hubPageMenuPanel">
  ...
  <a href="/resume" class="hub-page-menu-item"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M4 7h16"/><path d="M4 12h16"/><path d="M4 17h16"/></svg>Resume Sessions</a>
