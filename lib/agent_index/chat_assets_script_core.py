...
<div class="hub-page-menu-panel" id="hubPageMenuPanel" hidden>
  <div class="hub-main-menu-stack">
    <div class="hub-main-menu-list-view">
      ...
      <button type="button" class="hub-page-menu-item" data-forward-action="openFinder" data-desktop-only="1"><span class="action-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7.5A2.5 2.5 0 0 1 5.5 5H10l2 2h6.5A2.5 2.5 0 0 1 21 9.5v7A2.5 2.5 0 0 1 18.5 19h-13A2.5 2.5 0 0 1 3 16.5z"></path><path d="M3 10h18"></path></svg></span><span class="action-label">Finder</span><span class="action-mobile">Finder</span></button>
      ...
      <button type="button" class="hub-page-menu-item" data-forward-action="openPaneTraceWindow" data-mobile-only="1"><span class="action-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h10"></path><path d="M18 17v4"></path><path d="m16 19 2-2 2 2"></path></svg></span><span class="action-label">Pane Trace</span><span class="action-mobile">Pane Trace</span></button>
      ...
      <button type="button" class="hub-page-menu-item positive" data-forward-action="addAgent"><span class="action-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="4.5" width="11" height="12" rx="2.6"></rect><circle cx="7.5" cy="9.5" r="0.85"></circle><circle cx="10.5" cy="9.5" r="0.85"></circle><path d="M7 12.7h4"></path><path d="M9 4.5V3"></path><line x1="21" y1="10.5" x2="16.5" y2="10.5"></line><line x1="18.75" y1="8.25" x2="18.75" y2="12.75"></line></svg></span><span class="action-label">Add Agent</span><span class="action-mobile">Add Agent</span></button>
      <button type="button" class="hub-page-menu-item danger" data-forward-action="removeAgent"><span class="action-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="4.5" width="11" height="12" rx="2.6"></rect><circle cx="7.5" cy="9.5" r="0.85"></circle><circle cx="10.5" cy="9.5" r="0.85"></circle><path d="M7 12.7h4"></path><path d="M9 4.5V3"></path><line x1="21" y1="10.5" x2="16.5" y2="10.5"></line></svg></span><span class="action-label">Remove Agent</span><span class="action-mobile">Remove</span></button>
    </div>
