...
def apply_color_tokens(text: str, settings: Mapping[str, object] | None = None) -> str:
    ...
    replacements: tuple[tuple[str, str], ...] = (
        ...
        ("rgb(0,0,0)", dark_bg),
        ("rgb(0, 0, 0)", dark_bg),
        # Legacy dark-gray literals
        ("rgb(15,15,15)", gray_panel_strong),
        ("rgb(15, 15, 15)", gray_panel_strong),
        ("rgb(20,20,20)", gray_surface),
        ("rgb(20, 20, 20)", gray_surface),
        ("rgb(20,20,19)", gray_surface),
        ("rgb(20, 20, 19)", gray_surface),
        ("rgb(25,25,25)", gray_surface_alt),
        ("rgb(25, 25, 25)", gray_surface_alt),
        ("rgb(25,25,24)", gray_surface_alt),
        ("rgb(25, 25, 24)", gray_surface_alt),
        ("rgb(30,30,30)", gray_hover),
        ("rgb(30, 30, 30)", gray_hover),
        ("rgb(30,30,29)", gray_hover),
        ("rgb(30, 30, 29)", gray_hover),
        ("rgb(64,64,64)", gray_inline_border),
        ("rgb(64, 64, 64)", gray_inline_border),
        ("rgb(158,158,158)", gray_muted),
        ("rgb(158, 158, 158)", gray_muted),
        ...
        ("rgb(255, 255, 255)", light_fg_bright),
        # Legacy dark-gray rgba channels
        ("rgba(15,15,15,", f"rgba({gray_panel_strong_channels},"),
        ("rgba(15, 15, 15,", f"rgba({gray_panel_strong_channels},"),
        ("rgba(20,20,20,", f"rgba({gray_surface_channels},"),
        ("rgba(20, 20, 20,", f"rgba({gray_surface_channels},"),
        ("rgba(20,20,19,", f"rgba({gray_surface_channels},"),
        ("rgba(20, 20, 19,", f"rgba({gray_surface_channels},"),
        ("rgba(25,25,25,", f"rgba({gray_surface_alt_channels},"),
        ("rgba(25, 25, 25,", f"rgba({gray_surface_alt_channels},"),
        ("rgba(25,25,24,", f"rgba({gray_surface_alt_channels},"),
        ("rgba(25, 25, 24,", f"rgba({gray_surface_alt_channels},"),
        ("rgba(30,30,30,", f"rgba({gray_hover_channels},"),
        ("rgba(30, 30, 30,", f"rgba({gray_hover_channels},"),
        ("rgba(30,30,29,", f"rgba({gray_hover_channels},"),
        ("rgba(30, 30, 29,", f"rgba({gray_hover_channels},"),
        ("rgba(64,64,64,", f"rgba({gray_inline_border_channels},"),
        ("rgba(64, 64, 64,", f"rgba({gray_inline_border_channels},"),
        ("rgba(158,158,158,", f"rgba({gray_muted_channels},"),
        ("rgba(158, 158, 158,", f"rgba({gray_muted_channels},"),
