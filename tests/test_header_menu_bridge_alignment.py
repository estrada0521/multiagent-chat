...
class HeaderMenuBridgeAlignmentTests(unittest.TestCase):
    def test_hub_header_buttons_keep_transparent_press_surface(self) -> None:
        style = hub_header_assets.HUB_PAGE_HEADER_CSS
        self.assertIn("appearance: none;", style)
        self.assertIn("-webkit-appearance: none;", style)
        self.assertIn(".hub-page-menu-btn:active { color: #fff; background: transparent !important; box-shadow: none !important; }", style)
    ...
    def test_hub_header_bridge_tracks_svg_hitbox(self) -> None:
        ...
        self.assertIn('bridge.style.background = "transparent";', script)
        self.assertIn('bridge.style.color = "transparent";', script)
    ...
    def test_chat_mobile_bridge_tracks_svg_hitbox(self) -> None:
        ...
        self.assertIn('bridge.style.background = "transparent";', source)
        self.assertIn('bridge.style.color = "transparent";', source)
